...
![](RackMultipart20200717-4-3ug7q8_html_d9e9c73319d45437.png)

Where m is the embedding dimension and Τ is the delay

The binary recurrence matrix R contains the value one for all close pairs.

Where N is the number of measured points xi, ![](RackMultipart20200717-4-3ug7q8_html_a85173550456db70.png)

ε is a threshold distance,

Θ (·) the Heaviside function (i.e. Θ(x) = 0, if x \&lt; 0, and Θ(x) = 1, otherwise) and
...
![](RackMultipart20200717-4-3ug7q8_html_1e97f5129851ce5d.png)
...
![](RackMultipart20200717-4-3ug7q8_html_be46419732a9651b.png)
...
![](RackMultipart20200717-4-3ug7q8_html_f665853fc9e7d49.png)
...
|
### **pyunicorn&#39;s timeseries.recurrence\_plot**
The RecurrencePlot class supports the construction of recurrence plots from multi-dimensional time series, optionally using embedding.
### **pyunicorn&#39;s timeseries.recurrence\_network**
Creates an embedding of the given time series, calculates a recurrence plot from the embedding and then creates a Network object from the recurrence plot, interpreting the recurrence matrix as the adjacency matrix of a complex network. Either recurrence threshold, recurrence rate or local recurrence rate have to be given as keyword arguments.
### **pyunicorn&#39;s transitivity()**
Returns the transitivity (coefficient) which is the ratio of three times the number of triangles to the number of connected triples of vertices C\_1.
### **pyunicorn&#39;s global\_clustering()**
Returns the mean of the local clustering coefficient. |
| --- |
